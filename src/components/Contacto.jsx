...
function Contacto() {
  ...
  return (
    <div className="flex justify-start flex-col md:flex-row">
      <div className=" w-full md:w-2/3 min-h-screen text-center pt-24 lg:pt-32">
        ...
        <div className="pb-8 text-lg lg:text-xl 2xl:text-2xl text-left pt-8 ">
        <div className=" lg:flex justify-end md:flex justify-center md:hidden pt-6 ">
          <FormContacto />
        </div>
      </div>
    </div>
