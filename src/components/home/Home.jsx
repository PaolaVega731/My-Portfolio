...
function Home() {
  ...
  return (
    <div className={`min-h-screen flex flex-col items-center justify-center p-12 lg:mb-8 mb-8 mt-32`}>
      ...
      <div className="min-h-screen flex flex-col items-center">
        <div className="max-w-4xl w-full">
          <div className="bg-[#FAF2D3] flex p-4 shadow-md rounded-md mb-4">
            <img
              src="/My-Portfolio/Les Vegetarianes.png"
              alt="Les Vegetarianes"
              className="h-40 object-contain rounded-l mr-8"
            />
          ...
          <div className="bg-[#FAF2D3] flex p-6 shadow-md rounded-md mb-4">
            <img
              src="/My-Portfolio/OrganiChic.png"
              alt="OrganiChic"
              className="h-40 object-contain rounded-l mr-4"
            />
            <div className="flex-grow">
